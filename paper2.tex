...
{\bf The presence of large-scale diffuse radio synchrotron emission in clusters
  ...
  at GHz frequencies ($\lesssim 100$~kpc) challenges theoretical model to
...
Section~\ref{sec:4} with a 10 per cent fraction of radio-loud clusters (black solid
...
which motivates our upper redshift limit. \qc{\bf Note also that at these high redshifts, 
...
R{\"o}ttgering for the useful discussions.  Finally, we thank the MultiDark 
...
impose a lower floor to the reported uncertainties of 10 per cent to account for
...
found that the SZ decrement at $\sim5$~GHz is below 10 per cent.
