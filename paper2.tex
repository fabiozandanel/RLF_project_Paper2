...
\caption{RH luminosity function (RLF) at 1.4~GHz. The top left panel shows the
  ...
  $L_{1.4~\rmn{GHz}}-L_{\rmn{X,bol}}$ relation \qc{from in Fig.~\ref{fig:PLSZ}} to the MultiDark clusters at $z =
  ...
  $L_{1.4~\rmn{GHz}}-Y_{\rmn{SZ}, 500}$ relation \qc{from in Fig.~\ref{fig:PLSZ}} to the MultiDark clusters at $z
...
\qc{observed} $L_{1.4~\rmn{GHz}}-L_{\rmn{X,bol}}$ and $L_{1.4~\rmn{GHz}}-Y_{\rmn{SZ}}$
relations \qc{(as in Fig.~\ref{fig:PLSZ})} to our $z = 0.2$ mock catalog, which employs our phenomenological gas
