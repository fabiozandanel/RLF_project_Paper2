...
\caption{RH luminosity function $n(L,z)$ at 120~MHz (top left panel) and cumulative
  ...
  MultiDark samples (bottom) to the constrained analytical model.  \qc{The bottom panels 
  of these two panels show the relative differences $\Delta n / n =
  (n_{\rmn{analytical}} - n_{\rmn{fit}})/n_{\rmn{fit}}$ (top) and
  $\Delta n / n = (n_{\rmn{analytical}} - n_{\rmn{simulation}})/n_{\rmn{simulation}}$ (bottom).} 
  Additionally shown is the LOFAR Tier~1 \emph{point-source} flux limit of
