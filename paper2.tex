...
%  emission to peripheral leptonic emission due to Fermi I or II re-acceleration
...
The spatial CR distribution $C(R)$ within a galaxy cluster is governed by an interplay
...
%{\bf Note that calibrating our model to 1.4~GHz observations may cause 
...
population, respectively.} %--> still not clear to me
